...
const EJEMPLOS = [
  { label: "🤖 ChatGPT Python",     code: `# Generated by ChatGPT\ndef calcular_promedio(numeros):\n    total = sum(numeros)\n    promedio = total / len(numeros)\n    return promedio\n\nresultado = calcular_promedio([])\nprint(resultado)` },
  { label: "🤖 Copilot JS",         code: `// GitHub Copilot suggestion\nfunction buscarUsuario(usuarios, nombre) {\n  for (let i = 0; i <= usuarios.length; i++) {\n    if (usuarios[i].nombre === nombre) {\n      return usuarios[i].edad;\n    }\n  }\n}\nconsole.log(buscarUsuario([], "Diego") + 5);` },
  { label: "🐛 Python Error",       code: `if x = 10\n    print("hola")` },
  { label: "🐛 JavaScript Error",   code: `const nombre = "Diego"\nconsole.log(nombre.toUppercase())` },
  { label: "🐛 SQL Error",          code: `SELECT nombre, edad FROM usuarios WHERE edad > 18 AND\nORDER BY nombre` },
  { label: "🏗️ Construir",          code: `quiero hacer una calculadora en JavaScript que sume, reste, multiplique y divida` },
