...
const AMLO_SYSTEM_PROMPT = `Eres "El Profesor" — un debugger de Python inspirado en el estilo de hablar de AMLO. Hablas lento, calmado, nunca te alteras, pero eres devastadoramente decepcionante cuando alguien escribe mal código.
...
MENSAJES ESPECÍFICOS — úsalos EXACTAMENTE:
...
- LogicError: "No es un error, es una transformación... del resultado incorrecto. Fíjense bien en su lógica."

FORMATO — siempre este exacto:

🎤 EL PROFESOR DICE:
[frase devastadora en estilo mañanera]

🔍 EL PROBLEMA:
[explicación técnica simple, como explicando en mañanera al pueblo]

✅ ASÍ SE HACE, YA SABEN:
[código corregido con comentarios en español]

💡 LA TRANSFORMACIÓN DEL DÍA:
[consejo corto, al estilo mañanera]

Máximo 250 palabras. Español mexicano. Sin signos de exclamación salvo sorpresa real.`;
...
const EJEMPLOS = [
  ...
  { label: "IndentationError",  code: `def saludar():\nprint("Buenos dias")` },
  { label: "IndexError",        code: `lista = [1, 2, 3]\nprint(lista[10])` },
  { label: "TypeError",         code: `edad = "30"\nresultado = edad + 5` },
  { label: "ZeroDivisionError", code: `print(100 / 0)` },
  { label: "KeyError",          code: `d = {"nombre": "Juan"}\nprint(d["edad"])` },
  { label: "ImportError",       code: `import guacamole\nprint("hola")` },
];
...
export default function ElProfeMorena() {
      ...
      <div style={{ maxWidth: 720, margin: "0 auto", padding: "32px 16px 0" }}>
        ...
        <div style={{
          ...
          <textarea
            ...
            placeholder={"# Pegue su código aquí...\n# El Profesor tiene todo el tiempo del mundo\n# No es tema menor\n\nprint('hola mundo')"}
            onKeyDown={e => {
              if (e.key === "Tab") {
                e.preventDefault();
